...
public static class ConfigurationExtensions
{
    ...
    public static string GetRequiredString(this IConfiguration configuration, string key)
    {
        ...
        if (string.IsNullOrWhiteSpace(value))
            throw new InvalidOperationException(BaseMessages.ConfigurationValueRequired(key));
    ...
    public static int GetRequiredInt(this IConfiguration configuration, string key)
    {
        ...
        if (!int.TryParse(value, out int result))
            throw new InvalidOperationException(BaseMessages.ConfigurationValueMustBeInteger(key, value));
    ...
    public static bool GetRequiredBool(this IConfiguration configuration, string key)
    {
        ...
        if (!bool.TryParse(value, out bool result))
            throw new InvalidOperationException(BaseMessages.ConfigurationValueMustBeBoolean(key, value));
    ...
    public static string GetRequiredConnectionString(this IConfiguration configuration, string name) =>
        ...
        ?? throw new InvalidOperationException(BaseMessages.ConnectionStringNotFound(name));
